...
<div class="max-w-3xl">
    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
        ...
        <div class="flex gap-3 pt-2">
            <button type="submit" class="px-6 py-2.5 bg-linear-to-r from-sky-500 to-indigo-600 text-white font-bold rounded-xl hover:shadow-lg transition-all text-sm">Simpan Produk</button>
