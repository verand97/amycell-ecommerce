...
{{-- Hero Section --}}
<section class="relative overflow-hidden bg-gradient-to-br from-slate-900 via-sky-950 to-indigo-950 text-white min-h-[85vh] flex items-center">
    ...
    <div class="relative max-w-7xl mx-auto px-4 py-20 text-center">
        ...
        <h1 class="text-5xl sm:text-6xl lg:text-7xl font-black leading-tight mb-6">
            Toko Digital
            <span class="bg-gradient-to-r from-sky-400 to-indigo-400 bg-clip-text text-transparent block">Terlengkap</span>
        </h1>
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            <a href="{{ route('catalog') }}" class="px-8 py-4 bg-gradient-to-r from-sky-500 to-indigo-600 rounded-2xl text-white font-bold text-lg hover:shadow-2xl hover:shadow-sky-500/30 transition-all hover:-translate-y-1 hover:scale-105">
                🛒 Belanja Sekarang
            </a>
...
{{-- Latest Products --}}
<section class="bg-gradient-to-br from-slate-800 to-slate-900 py-16">
...
<section class="max-w-7xl mx-auto px-4 py-16">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="text-center p-8 bg-white rounded-3xl border border-slate-100 hover:shadow-xl transition-all hover:-translate-y-1">
            <div class="w-16 h-16 bg-gradient-to-br from-sky-400 to-indigo-500 rounded-2xl flex items-center justify-center text-3xl mx-auto mb-4">⚡</div>
        ...
        <div class="text-center p-8 bg-white rounded-3xl border border-slate-100 hover:shadow-xl transition-all hover:-translate-y-1">
            <div class="w-16 h-16 bg-gradient-to-br from-emerald-400 to-teal-500 rounded-2xl flex items-center justify-center text-3xl mx-auto mb-4">💰</div>
        ...
        <div class="text-center p-8 bg-white rounded-3xl border border-slate-100 hover:shadow-xl transition-all hover:-translate-y-1">
            <div class="w-16 h-16 bg-gradient-to-br from-purple-400 to-pink-500 rounded-2xl flex items-center justify-center text-3xl mx-auto mb-4">🛡️</div>
