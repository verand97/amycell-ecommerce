                    ...
                    <div class="grid sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="shipping_name" value="{{ old('shipping_name', auth()->user()->name) }}" required
                                class="w-full px-4 py-2.5 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-sky-500 focus:border-sky-500 outline-none transition-all @error('shipping_name') border-red-400 @enderror">
                ...
                <div class="bg-white rounded-2xl border border-slate-100 p-5 shadow-sm sticky top-20">
                    ...
                    <div class="space-y-3 mb-4 max-h-60 overflow-y-auto">
                        ...
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 bg-slate-100 rounded-lg flex items-center justify-center flex-shrink-0 text-lg">
                                {{ $item['type'] === 'digital' ? '⚡' : '📦' }}
                            </div>
                    ...
                    <button type="submit"
                        class="mt-5 w-full py-3.5 bg-gradient-to-r from-sky-500 to-indigo-600 text-white font-bold rounded-2xl hover:shadow-xl hover:shadow-sky-200 transition-all hover:-translate-y-0.5 text-sm">
                        ✅ Buat Pesanan
                    </button>
